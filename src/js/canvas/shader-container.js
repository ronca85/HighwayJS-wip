...
export default class Antoni {
	constructor(){
		...
		this.container = document.getElementById("bg-transition");
	...
	add(){
		this.material = new THREE.ShaderMaterial({
			...
			uniforms: {
				...
				texture1: { value: THREE.ImageUtils.loadTexture("img/4.jpg") },
				texture2: { value: THREE.ImageUtils.loadTexture("img/4.jpg") },
			},
			vertexShader: vertex,
